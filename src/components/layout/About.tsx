...
export function About() {
  return (
    <div className="bg-linear-to-b from-transparent to-c-lightcyan/30">
      <article className="max-w-250 mx-auto px-3 gap-5 pb-8 text-c-jetblack flex flex-col">
        <header>
        ...
        <section className="">
          <p>
            ...
            platform built as a portfolio project during the Northcoders
            Software Development Bootcamp. The application demonstrates
            full-stack JavaScript development with a complete separation between
        ...
        <section className="">
          ...
          <ul className="font-mono">
            <li>
              <strong>Stack:</strong> Express.js REST API with PostgreSQL
              database
            </li>
            <li>
              <strong>Hosted:</strong> Server on Render.com, Database on
              Supabase
            </li>
            <li>
          ...
          <ul className="font-mono">
            ...
            <li>
              ...
              <ul>
                ...
                <li>
                  Sort articles by various criteria (date, votes, comments)
                </li>
        ...
        <section className="">
          ...
          <p className="font-mono">
            ...
            users can discover content through topic-based filtering, engage
            with articles through commenting and voting, and manage their own
            contributions. The frontend communicates with the RESTful backend
            API to fetch articles, topics, comments, and user data, whilst
            handling all CRUD operations for content management.
          </p>
        </section>
        ...
        <section className="">
          ...
          <ul className="flex flex-col gap-2 font-mono">
            <li>
              Custom React hooks for content fetching, filtering, user
              management, and scroll behaviour
            </li>
            <li>
          ...
          <nav>
            <ul>
              <li>
                ...
                <Link
                  className="text-c-duskblue font-semibold"
                  target="_blank"
                  to="https://zsolts-news.onrender.com/api/"
                >
                  https://zsolts-news.onrender.com/api/
                </Link>
              </li>
              ...
              <li>
                ...
                <Link
                  className="text-c-duskblue font-semibold"
                  target="_blank"
                  to="https://github.com/zsolt-wvdrppr"
                >
